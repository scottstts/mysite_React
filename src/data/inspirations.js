export const inspirations = [
  {
    id: 'elon',
    name: 'Elon Musk',
    tagline: 'I would pick flawed authenticity over faked perfection any day.',
    description: `To borrow the ending of the Elon Musk biography by Walter Isaacson, "They can be reckless, cringeworthy, sometimes even toxic. They can also be crazy. Crazy enough to think they can change the world."

Elon is pure, an extremely rare trait these days, especially in public figures. He always says what he means and means what he says. This is why he is always surrounded by controversies. But even among these controversies, you should never ignore the fact that he has advanced frontier exploration of modern time more than any single individual in history. In fact, this is my litmus test for people–you can disagree with his opinions all you want, sometimes I disagree with them as well. But if you would go as far as writing off all his achievements simply because you don't like what he says, I know we are not the same people.
...
His brilliance, hard work, determination, execution, honesty, and good heart are among some of the things I constantly look up to.`,
  ...
  },
  {
    id: 'jensen',
    name: 'Jensen Huang',
    tagline: 'The only limitation is your imagination and execution.',
    description: `From a dishwasher to Founder/CEO of the biggest and most influential company in the world today, how can you not find Jensen Huang inspiring?
...
Jensen tells the story with his own life that you can just do things.`,
  ...
  },
  {
    id: 'naval',
    name: 'Naval Ravikant',
    tagline: 'Imagine the wisest philosopher you\'ve read, now look at Naval\'s tweets.',
    description: `My life was not the same after I was introduced with The Almanack of Naval Ravikant. Life is a willful journey. If you go through your life just doing things without giving them much thought, you are just a group of molecules drifting where the universe takes you.
...
I am glad Andrej decided to go all in on democratizing AI education after his journey at OpenAI and Tesla, which God knows people now and in the future desperately need. He is a phenomenal educator and just one of the most brilliant minds out there.`,
  ...
  },
  {
    id: 'pieter',
    name: 'Pieter Levels',
    tagline: 'Digital nomad is a statement of freedom, honesty, and getting shit done.',
    description: `Funny enough, before Levels went on the Lex Pod, I'd never heard of him or the concept of digital nomad, now I find myself often contemplating the beauty of this way of life.
