...
export const apps: App[] = [
  {
    ...
    description: `Step off the tram into the first park on another world. Under a 260-metre glass dome on the Elysium Planitia flats, five hectares of paved plaza, working farm and quiet terrace sit inside a ring of red mountains you can see from anywhere in it — a whole small town's worth of place, rendered in real time and walked in first person at true Martian gravity. Every rivet of it is generated by code: the gridshell overhead, the regolith underfoot, the lettuce on the greenhouse benches, the dust the washer robot has not reached yet. There are no menus, no meters and no monsters. There is a low frozen sun, a tram that comes round every few minutes, and a planet on the other side of the glass.`,
    videos: [
      {
        videoId: 'B2Xy8GQSX8o',
        title: 'Elysium - First Park on Mars',
      },
    ],
    link: 'https://mars.scottsun.io',
    showLink: true,
  },
  {
    id: 'pearl',
  ...
  },
  {
    ...
    tagline: 'Nostalgia.',
    description: `I have no reason to create this other than the fond nostalgia. And that's reason enough.<br><br>

    Made with Blender MCP, and directly ported from Python to Three.js procedurally.`,
    videos: [
      {
        videoId: 'osiF-gJvm7U',
