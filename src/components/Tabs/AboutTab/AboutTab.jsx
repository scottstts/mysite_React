    ...
    <div className="about-tab space-y-8">
      ...
      <GlassCard className="rounded-2xl p-8 fade-in">
        <div className="space-y-8">
          ...
          <p className="text-lg text-white mb-8 leading-relaxed text-left">
            I believe that all problems are eventually solvable through technology without introducing any additional externality. Technology evolves—gradually or rapidly—to match the complexity of problems. Today's flawed solutions will never capture how easily these problems may be resolved in the future.<br /><br />
          ...
          <GlassCard className="rounded-xl p-6 mt-8">
